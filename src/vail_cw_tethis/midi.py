...
class MidiKeyer:
    def __init__(
        ...
        self._dit_note_down = False
        self._dah_note_down = False
        self._running = False
    ...
    def _handle_message(self, message: mido.Message) -> None:
        ...
        if note == self._mapping.dit_note:
            if is_down == self._dit_note_down:
                return
            self._dit_note_down = is_down
            self._dit_down = is_down
            self._last_dit_source = "note"
        elif note == self._mapping.dah_note:
            if is_down == self._dah_note_down:
                return
            self._dah_note_down = is_down
            self._dah_down = is_down
